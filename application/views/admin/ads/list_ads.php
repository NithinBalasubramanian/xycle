...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Dashboard / List Ads </h1>
...
<div class="col-xl-12 col-lg-7">
  <div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-flex flex-row align-items-center row">
      <h6 class="col-md-6 m-0 font-weight-bold text-primary">List Ads Table</h6>
    ...
    <table id="dataTable" class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                <?php $customer = $this->Admin_model->table_column($tablename='ads','status','1');
				if(count($customer) >0) {
          $i=1;
                ...
                <tr>
                 ...
                 <!-- <td>
                 <button type="button" class="btn btn-sm btn-success" id="block" data-rowid="<?php echo $row['id']; ?>" value="<?php echo $row['status']; ?>" <?php if($row['status'] != 0){?> >block</button> <?php  } ?>
                 </td> -->
                  <td><a href="<?php echo base_url();?>Delete/ads/ads/list_ads/<?php echo $row['id'];?>"><i class="fa fa-trash-o" aria-hidden="true" style="font-size:20px;"></i></a></td>
       <?php $i++; } ?>
        <?php } ?>
                </tbody>
              </table>
