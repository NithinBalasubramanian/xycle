        ...
        if(count($profile) > 0)
        {
            ...
            <div class="row">
			   <div class="form-group col-md-6">
                  ...
                  <div class="col-sm-12">
                    <input type="text" name= "plan" class="form-control" id="inputEmail3" value="<?php echo $row['plan']; ?>" autocomplete="off">
                  </div>
                </div>
                <div class="form-group col-md-6">
                  <label for="inputEmail3" class="col-sm-6 control-label">Amount</label>
                  <div class="col-sm-12">
                    <input type="text" name="amount" class="form-control overall" id="inputEmail3" value="<?php echo $row['amount']; ?>" autocomplete="off">
                  </div>
                </div>
              </div>
            </div> 
            <div class="row">
			   <div class="form-group col-md-6">
                  ...
                  <div class="col-sm-12">
                    <input type="text" name= "discount" class="form-control discount" id="inputEmail3 " value="<?php echo $row['discount']; ?>"  autocomplete="off">
                  </div>
                </div>
                <div class="form-group col-md-6">
                  <label for="inputEmail3" class="col-sm-6 control-label">Final Price</label>
                  <div class="col-sm-12">
                    <input type="text" name= "final" class="form-control final" id="inputEmail3 " value="<?php echo $row['final']; ?>" autocomplete="off">
                  </div>
                </div>
            ...
            <div class="row">
			   <div class="form-group col-md-6">
                  <label for="inputEmail3" class="col-sm-6 control-label">Valid Month</label>
                  <div class="col-sm-12">
                    <input type="text" name= "valid" class="form-control" id="inputEmail3" value="<?php echo $row['valid']; ?>" autocomplete="off">
                  </div>
                </div>
            </div>
