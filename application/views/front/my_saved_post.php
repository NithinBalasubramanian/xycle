...
<div class="main_content">
    <div class="new_icon">
        ...
        <a href="<?php echo base_url(); ?>View/front/my_saved_post" class="new_icon2" style="color:#000000;">
     ...
     <?php  $user_id=$this->session->userdata('user_id');
     $saved_one  = $this->Admin_model->table_column('saved','user_id',$user_id);
     if(count($saved_one) > 0){
         foreach($saved_one as $saved_row){
     $card_data=$this->Admin_model->table_column_desc('ecard','id',$saved_row['saved_id']);
     $i=1;
     $k=1;
