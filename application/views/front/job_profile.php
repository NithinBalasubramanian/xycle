...
<div class="main_content" >
    ...
    <div class="list">
        <form class="row cart" method="post" action="<?php echo base_url(); ?>front/job_profile"  enctype="multipart/form-data">
            ...
            <div class="col-sm-12 form-group">
                ...
                <input type="text" class="form-control input_box title" name="sub_head[]"  placeholder="Sub Heading" style="width:80%">
            </div>
            <div class="col-sm-12 form-group">
                <label for="look">Description</label>
                <textarea type="text" class="form-control input_box description" row="3" name="sub_description[]"  placeholder="Enter Description" style="width:80%"></textarea>
            </div>
            <div class="col-sm-12 form-group" >
            ...
            <div class="col-sm-12 form-group">
                ...
                <textarea type="text" class="form-control input_box description" row="3"name="note"  placeholder="Enter Notes" style="width:80%"></textarea>
            </div>
            <div class="col-sm-12 form-group">
                <label for="look">Terms</label>
                <textarea type="text" class="form-control input_box description" row="3"name="term"  placeholder="Enter Terms" style="width:80%"></textarea>
            </div>
