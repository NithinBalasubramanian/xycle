	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" action="<?php echo base_url(); ?>Front/phone_verification">
				...
				<div style="width: 100%;padding: 10%;">
					...
					<div class="text-center p-t-115">
						...
						<a class="txt2" href="<?php echo base_url(); ?>View_init/front/login">
							Sign In
						</a>
					</div>
				</form>
