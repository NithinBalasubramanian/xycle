...
<div class="main_content">
    <div class="container">
    <div class="row">
       <a href="<?php echo base_url(); ?>View/front/add_post" class="col-md-6 "><input name="content" class="content" rows="2" placeholder="Create Your Post Here"></a>
    </div>
    </div>
    
    
     <?php $card_data=$this->Admin_model->table_column_desc('ecard');
     $i=1;
     $k=1;
    ...
    <?php $pro_data=$this->Admin_model->table_column('profile','user_id',$row['user_id']);
        ...
        <div class="top_part">
            ...
            <?php $saved_data = $this->Admin_model->table_column('saved','user_id',$user_id,'saved_id',$row['id']);
                ...
                <p><a href="<?php echo base_url(); ?>View/front/<?php echo $row['post_type'];?>_edit/<?php echo $row['id'];?>">Edit</a></p>
                <p>Analytics</p>
                <p><a href="<?php echo base_url(); ?>View/front/promote_page/<?php echo $row['id'];?>">Promote</p>
...
<p>Follow Me On</p>
    <div class="links">
        ...
        <?php }elseif($row['post_type'] == 'job_profile'){
            $e_data = $this->Admin_model->table_column('job_profile','ecart_id',$row['id']);
            foreach($e_data as $row_1){ ?>
            <div class="promo_cont meme_cont">
        ...
        <div class="post_bottom_part">
            ...
            <div class="post_bottom_options send_this">
               <i class="fa fa-arrow-right icon_2" aria-hidden="true"></i>
        ...
        <?php $comment_data = $this->Admin_model->table_column_desc('comment','comment_on',$row['id']);
...
<script>
    ...
    $(document).on('click','.send_this',function(){
        $(this).parent().next().next().toggleClass('view_this');
    });
...
<script>
	 $(document).on('submit','#comment_on',function(e){
        ...
        $.ajax({
            ...
            $(this).parent().next().next().append('<p><b>'+user_data+'</b> : '+comment+'</p>');
    });
    </script>
    <script>
