...
<div class="main_content">
    <div class="new_icon">
        <a href="<?php echo base_url(); ?>View/front/my_post" class="new_icon1">
        ...
        <a href="<?php echo base_url(); ?>View/front/my_shared_post"  class="new_icon3" style="color:#000000;">
            <i class="fa fa-clipboard content_icon" aria-hidden="true"></i>
            <p class="icon_sub">Shared</p>
        </a>
    </div>
     <?php  $user_id=$this->session->userdata('user_id');
     $saved_one  = $this->Admin_model->table_column('shared','user_id',$user_id);
     if(count($saved_one) > 0){
         foreach($saved_one as $saved_row){
     $card_data=$this->Admin_model->table_column_desc('ecard','id',$saved_row['shared_id']);
     $i=1;
     $k=1;
