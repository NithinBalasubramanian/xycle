	...
	<div class="limiter">
		<div class="container-login100">
            ...
            <a href="<?php echo base_url(); ?>View/front/profile_profession_edit" class="btn btn-success btn-sm success" style="margin-top:-55px;float: right;">Skip
            ...
            <div class="new_icon">
            <div class="about_you">
                <a href="<?php echo base_url(); ?>View/front/profile_edit" class="about_you_p"  style="background-color:#20BA1A;">About You</a>
            </div>
            <div class="profession">
                <a href="<?php echo base_url(); ?>View/front/profile_profession_edit" class="profession_p" style="color:#000000;">Profession</a>
            </div>
