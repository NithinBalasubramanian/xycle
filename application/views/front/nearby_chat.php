...
<div class="new_icon">
        ...
        <a href="<?php echo base_url(); ?>View/front/nearby_chat" class="new_icon2" style="color:#000000;">
            <i class="fa fa-map-marker content_icon" aria-hidden="true" style="text-align:center;"></i>
